...
SELECT artist.artist_id AS artist_id, artist.name AS artist_name0, SUM(invoice_line.unit_price*invoice_line.quantity) AS artist_name
FROM invoice_line
...
---Q2 Find out the most popular music genre for each country. We determine the most popular genre as the genre with the highest
